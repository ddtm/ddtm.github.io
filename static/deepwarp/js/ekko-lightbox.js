  ...
  EkkoLightbox.prototype = {
    modal_shown: function() {
      ...
      if (!this.options.remote) {
        ...
        if (this.options.type) {
          ...
          } else if (this.options.type === 'ani') {
            return this.showAni(this.options.remote);
          } else {
    ...
    showAni: function(url) {
      ...
      video.bind('loadeddata', function(e) {
        this_.resize(this.videoWidth);
      });
      this.lightbox_body.html(video);
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
        this.modal_arrows.css('display', 'none');
      }
    ...
    preloadAni: function(src) {
      var video = $('<video />', {
        autoplay: true,
        loop: true
      });
      video.onload = (function(_this) {
        return function() {
          var v;
          v = $('<video />');
          v.attr('src', video.src);
          _this.lightbox_body.html(v);
          return v.load(function() {
            _this.resize(v.width);
            return _this.options.onContentLoaded.call(_this);
          });
        };
      })(this);
      video.onerror = (function(_this) {
        return function() {
          return _this.error('Failed to load video: ' + src);
        };
      })(this);
      video.src = src;
      video.load();
